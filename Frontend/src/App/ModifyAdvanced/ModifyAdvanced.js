            ...
            <div className="advanced-layout">
                ...
                <section className="settings-section">
                    ...
                    <div className="field-row">
                        ...
                        <button className="field-edit" type="button" onClick={() => toggleField("education")} aria-label="Edit education">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <button className="field-edit" type="button" onClick={() => toggleField("experience")} aria-label="Edit experience">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <button className="field-edit" type="button" onClick={() => toggleField("age")} aria-label="Edit age">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <div className="field-value">
                            {!fieldEditing.MainBranch ? (
                                ...
                                <Form.Control as="select" name="MainBranch" value={formData.MainBranch} onChange={handleChange}>
                                    <option value="">Select which best describes you today</option>
                                    {MainBranchs.map((v, i) => <option key={i} value={v}>{v}</option>)}
                                </Form.Control>
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("MainBranch")} aria-label="Edit profession">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <div className="field-value">
                            {!fieldEditing.RemoteWork ? (
                                ...
                                <Form.Control as="select" name="RemoteWork" value={formData.RemoteWork} onChange={handleChange}>
                                    <option value="">Select your current situation</option>
                                    {RemoteWork.map((v, i) => <option key={i} value={v}>{v}</option>)}
                                </Form.Control>
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("RemoteWork")} aria-label="Edit remote work">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <div className="field-value">
                            {!fieldEditing.DevType ? (
                                ...
                                <Form.Control as="select" name="DevType" value={formData.DevType} onChange={handleChange}>
                                    <option value="">Select your current job</option>
                                    {DevType.map((v, i) => <option key={i} value={v}>{v}</option>)}
                                </Form.Control>
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("DevType")} aria-label="Edit developer type">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <div className="field-value">
                            {!fieldEditing.OrgSize ? (
                                ...
                                <Form.Control as="select" name="OrgSize" value={formData.OrgSize} onChange={handleChange}>
                                    <option value="">How many people are employed?</option>
                                    {OrgSize.map((v, i) => <option key={i} value={v}>{v}</option>)}
                                </Form.Control>
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("OrgSize")} aria-label="Edit org size">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <div className="field-value">
                            {!fieldEditing.ICorPM ? (
                                ...
                                <Form.Control as="select" name="ICorPM" value={formData.ICorPM} onChange={handleChange}>
                                    <option value="">Choose one</option>
                                    {ICorPM.map((v, i) => <option key={i} value={v}>{v}</option>)}
                                </Form.Control>
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("ICorPM")} aria-label="Edit IC/PM">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <button className="field-edit" type="button" onClick={() => toggleField("Industry")} aria-label="Edit industry">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <button className="field-edit" type="button" onClick={() => toggleField("YearsCode")} aria-label="Edit years coding">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <button className="field-edit" type="button" onClick={() => toggleField("YearsCodePro")} aria-label="Edit years pro">
                            <span className="chev" />
                        </button>
                    </div>
                    ...
                    <div className="field-row">
                        ...
                        <button className="field-edit" type="button" onClick={() => toggleField("JobSat")} aria-label="Edit job satisfaction">
                            <span className="chev" />
                        </button>
                    </div>
                        ...
                        <div className="field-value">
                            {!fieldEditing.languages ? (
                                formData.languages?.length ? (
                                    <div className="chips">{formData.languages.map(v => <span className="chip" key={v}>{v}</span>)}</div>
                                ...
                                <Select
                                    ...
                                    onChange={(selected) => setFormData(fd => ({ ...fd, languages: (selected || []).map(o => o.value) }))}
                                    menuPlacement="top"
                                    placeholder="Select the languages you've used extensively in the past year"
                                />
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("languages")} aria-label="Edit languages">
                            <span className="chev" />
                        </button>
                    </div>
                        ...
                        <div className="field-value">
                            {!fieldEditing.databases ? (
                                formData.databases?.length ? (
                                    <div className="chips">{formData.databases.map(v => <span className="chip" key={v}>{v}</span>)}</div>
                                ) : <span className="value-text">Not Provided</span>
                            ) : (
                                <Select
                                    isMulti
                                    ...
                                    onChange={(selected) => setFormData(fd => ({ ...fd, databases: (selected || []).map(o => o.value) }))}
                                    menuPlacement="top"
                                    placeholder="Select the databases you've used extensively in the past year"
                                />
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("databases")} aria-label="Edit databases">
                            <span className="chev" />
                        </button>
                    </div>
                        ...
                        <div className="field-value">
                            {!fieldEditing.platforms ? (
                                formData.platforms?.length ? (
                                    <div className="chips">{formData.platforms.map(v => <span className="chip" key={v}>{v}</span>)}</div>
                                ) : <span className="value-text">Not Provided</span>
                            ) : (
                                <Select
                                    isMulti
                                    ...
                                    onChange={(selected) => setFormData(fd => ({ ...fd, platforms: (selected || []).map(o => o.value) }))}
                                    menuPlacement="top"
                                    placeholder="Select the platforms you've used extensively in the past year"
                                />
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("platforms")} aria-label="Edit platforms">
                            <span className="chev" />
                        </button>
                    </div>
                        ...
                        <div className="field-value">
                            {!fieldEditing.webframesworks ? (
                                formData.webframesworks?.length ? (
                                    <div className="chips">{formData.webframesworks.map(v => <span className="chip" key={v}>{v}</span>)}</div>
                                ) : <span className="value-text">Not Provided</span>
                            ) : (
                                <Select
                                    isMulti
                                    ...
                                    onChange={(selected) => setFormData(fd => ({ ...fd, webframesworks: (selected || []).map(o => o.value) }))}
                                    menuPlacement="top"
                                    placeholder="Select the web frameworks you've used extensively in the past year"
                                />
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("webframesworks")} aria-label="Edit web frameworks">
                            <span className="chev" />
                        </button>
                    </div>
                        ...
                        <div className="field-value">
                            {!fieldEditing.tools ? (
                                formData.tools?.length ? (
                                    <div className="chips">{formData.tools.map(v => <span className="chip" key={v}>{v}</span>)}</div>
                                ) : <span className="value-text">Not Provided</span>
                            ) : (
                                <Select
                                    isMulti
                                    ...
                                    onChange={(selected) => setFormData(fd => ({ ...fd, tools: (selected || []).map(o => o.value) }))}
                                    menuPlacement="top"
                                    placeholder="Select the tools you've used extensively in the past year"
                                />
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("tools")} aria-label="Edit tools">
                            <span className="chev" />
                        </button>
                    </div>
                        ...
                        <div className="field-value">
                            {!fieldEditing.OpSys ? (
                                formData.OpSys?.length ? (
                                    <div className="chips">{formData.OpSys.map(v => <span className="chip" key={v}>{v}</span>)}</div>
                                ) : <span className="value-text">Not Provided</span>
                            ) : (
                                <Select
                                    isMulti
                                    ...
                                    onChange={(selected) => setFormData(fd => ({ ...fd, OpSys: (selected || []).map(o => o.value) }))}
                                    menuPlacement="top"
                                    placeholder="Select the Operating Systems you've used extensively in the past year"
                                />
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("OpSys")} aria-label="Edit operating systems">
                            <span className="chev" />
                        </button>
                    </div>
                        ...
                        <div className="field-value">
                            {!fieldEditing.employments ? (
                                formData.employments?.length ? (
                                    <div className="chips">{formData.employments.map(v => <span className="chip" key={v}>{v}</span>)}</div>
                                ) : <span className="value-text">Not Provided</span>
                            ) : (
                                <Select
                                    isMulti
                                    ...
                                    onChange={(selected) => setFormData(fd => ({ ...fd, employments: (selected || []).map(o => o.value) }))}
                                    menuPlacement="top"
                                    placeholder="Select all that describe your employment status"
                                />
                            )}
                        </div>
                        <button className="field-edit" type="button" onClick={() => toggleField("employments")} aria-label="Edit employment">
                            <span className="chev" />
                        </button>
                    </div>
                </section>
