...
const Recommendations = ({toggleScreen, isSignedIn, toggleSignendIn, exchangeRate, selectedCurrency}) => {
    ...
    return (
        <div className="recommendations-page">
                    ...
                    <ul className="rec-list">
                        {recommendations.map((rec, i) => (
                            <li key={i} className="rec-item">
                                ...
                                <span className="rec-inc">
                                 + {new Intl.NumberFormat('en', {
                                    style: 'currency', currency: selectedCurrency, maximumFractionDigits: 0
                                }).format(Math.floor(recommendationsIncrese[rec] * exchangeRate))}
                                </span>
                            </li>
                        ))}
                    </ul>
            ...
            <div className="btn-row">
                <button onClick={() => navigate("/AdvancedRecommendations")} className="profile-button is-outline">Advanced</button>
                <button onClick={() => navigate("/SavedRecommendations")} className="profile-button is-outline">Saved</button>
